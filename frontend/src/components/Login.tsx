              ...
              <div className='card-body'>
                ...
                <form onSubmit={handleSubmit}>
                  <div className='mb-3'>
                    ...
                    <input type='text' className='form-control' id='identifier' name='identifier' placeholder='Email o Usuario' value={formData.identifier} onChange={handleChange} required />
                  </div>
                  ...
                  <div className='mb-3'>
                    ...
                    <div className='d-flex align-items-center' style={{ position: 'relative' }}>
                      <input type={showPassword ? 'text' : 'password'} className='form-control' id='password' name='password' placeholder='Contraseña' value={formData.password} onChange={handleChange} required />
                      <svg style={{ position: 'absolute', right: '.5rem' }} onClick={() => setShowPassword(!showPassword)} xmlns='http://www.w3.org/2000/svg' height='24px' viewBox='0 -960 960 960' width='24px' fill='#999999'>
                        {showPassword ? (
